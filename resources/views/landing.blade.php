...
<body class="bg-gray-50">
    ...
    <header class="bg-gray-200 p-4 shadow-md mt-5">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <a href="{{ url('/cart') }}" id="cart-btn" class="relative flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300 shadow-md">
    ...
    <footer class="bg-gray-800 p-6 text-gray-400 mt-20">
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="flex flex-col items-center md:items-start">
                <img src="{{ asset('Images/AnimalCarePet.png') }}" alt="Animal Care Pet Logo" class="w-20 h-20 mb-4">
