@extends('layouts.manage') <!-- Use the old layout here -->
    ...
    <aside class="bg-gray-800 w-64 h-screen fixed top-0 left-0">
        ...
        <nav class="mt-10">
            ...
            <ul>
                ...
                <li class="mt-4">
                    <a href="{{ url('product/create') }}" class="flex items-center py-2 px-4 text-white-400 hover:bg-gray-600 hover:text-white">
                        <span>Add products</span>
                    </a>
                </li>
                <li class="mt-4">
                    <a href="{{ url('products') }}" class="flex items-center py-2 px-4 text-white-400 hover:bg-gray-600 hover:text-white">
                ...
                products.forEach(product => {
                    ...
                    productCard.innerHTML = `
                        ...
                        <div class="flex items-center gap-2 mt-3">
                            <a href="{{ url('product/edit') }}/${product.id}" class="bg-blue-600 hover:bg-blue-500 text-white h-fit px-2 py-1 rounded-lg">Edit</a>
